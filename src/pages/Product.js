          ...
          <div className="col-lg-6 col-md-12 mb-4">
            <div className="single-news mb-4">
              <div className="row">
                ...
                <div className="col-md-9">
                  <p className="font-weight-bold ">26/02/2018</p>
            ...
            <div className="single-news mb-4">
              <div className="row">
                ...
                <div className="col-md-9">
                  <p className="font-weight-bold ">25/02/2018</p>
                  <div className="d-flex justify-content-between">
                    <div className="col-11 text-truncate pl-0 mb-3">
                      <a href="#!" className="">
            ...
            <div className="single-news mb-4">
              <div className="row">
                ...
                <div className="col-md-9">
                  <p className="font-weight-bold ">24/02/2018</p>
                  <div className="d-flex justify-content-between">
                    <div className="col-11 text-truncate pl-0 mb-3">
                      <a href="#!" className="">
            ...
            <div className="single-news">
              <div className="row">
                ...
                <div className="col-md-9">
                  <p className="font-weight-bold ">23/02/2018</p>
                  <div className="d-flex justify-content-between">
